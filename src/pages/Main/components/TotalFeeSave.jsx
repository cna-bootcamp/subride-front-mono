    ...
    <TotalFeeSaveContainer>
      ...
      <p className="title">
        ...
        <span style={{ fontFamily: "KBFGDisplayB" }}>
          {" "}
          {totalFee.totalfee &&
            totalFee.totalfee.toLocaleString("ko-KR")}
          원{" "}
        </span>
      </p>
      <button className="subtitle-container" onClick={() => navigate("/subgroup-candidate")}>
        <p className="subtitle">
          썹 타고 매월 최대{" "}
          <span style={{ color: "#ff0000", fontSize: "18px", fontWeight: "bold" }}>
            {totalFee.totalSavedAmount &&
              totalFee.totalSavedAmount.toLocaleString("ko-KR")}
            원
          </span>{" "}
          아끼러 가기
        </p>
